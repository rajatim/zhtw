...
ACTIVE_FORMAL_PROTOCOL = ACCURACY_ROOT / "formal-blind-v2-protocol-v3.json"
...
BLIND_V2_SCHEMAS = (
    ...
    ACCURACY_ROOT / "blind-v2.annotation-packet.schema.json",
    ACCURACY_ROOT / "blind-v2.annotation-advisory.schema.json",
    ACCURACY_ROOT / "blind-v2.annotation-synthesis.schema.json",
    ACCURACY_ROOT / "blind-v2.annotation-batch-decision.schema.json",
    ACCURACY_ROOT / "blind-v2.annotation-decisions.schema.json",
