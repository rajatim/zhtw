...
benchmark-blind-v2-source-classification-check: ## Verify deterministic input-only source classification packet
	...
	$(PYTHON) scripts/compare_blind_v2_source_classifications.py --packet benchmarks/accuracy/review-packets/blind-v2-source-classification-batch-013.json --codex docs/reports/blind-v2-source-classification-codex-first-pass-batch-013-2026-07-24.json --gemini docs/reports/blind-v2-source-classification-gemini-independent-batch-013-2026-07-24.json --generated-date 2026-07-24 --output docs/reports/blind-v2-source-classification-diff-batch-013-2026-07-24.md --check
...
benchmark-blind-v2-pool-collecting-check: ## Rebuild and validate the current collecting pool
	$(PYTHON) scripts/promote_blind_v2_candidates.py --decision docs/reports/blind-v2-source-classification-maintainer-decision-batch-001-2026-07-21.json --decision docs/reports/blind-v2-source-classification-maintainer-decision-batch-002-2026-07-21.json --decision docs/reports/blind-v2-source-classification-maintainer-decision-batch-003-2026-07-22.json --decision docs/reports/blind-v2-source-classification-maintainer-decision-batch-004-2026-07-23.json --decision docs/reports/blind-v2-source-classification-maintainer-decision-batch-005-2026-07-23.json --decision docs/reports/blind-v2-source-classification-maintainer-decision-batch-006-2026-07-23.json --decision docs/reports/blind-v2-source-classification-maintainer-decision-batch-007-2026-07-23.json --decision docs/reports/blind-v2-source-classification-maintainer-decision-batch-008-2026-07-23.json --decision docs/reports/blind-v2-source-classification-maintainer-decision-batch-009-2026-07-23.json --decision docs/reports/blind-v2-source-classification-maintainer-decision-batch-010-2026-07-24.json --decision docs/reports/blind-v2-source-classification-maintainer-decision-batch-011-2026-07-24.json --decision docs/reports/blind-v2-source-classification-maintainer-decision-batch-012-2026-07-24.json --created-at 2026-07-24T00:00:00+08:00 --output $(BLIND_V2_POOL) --report docs/reports/blind-v2-candidate-promotion-batches-001-012-2026-07-24.md --check
