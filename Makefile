...
benchmark-blind-v2-pool-collecting-check: ## Rebuild and validate the current collecting pool
	$(PYTHON) scripts/promote_blind_v2_candidates.py --decision docs/reports/blind-v2-source-classification-maintainer-decision-batch-001-2026-07-21.json --decision docs/reports/blind-v2-source-classification-maintainer-decision-batch-002-2026-07-21.json --decision docs/reports/blind-v2-source-classification-maintainer-decision-batch-003-2026-07-22.json --decision docs/reports/blind-v2-source-classification-maintainer-decision-batch-004-2026-07-23.json --decision docs/reports/blind-v2-source-classification-maintainer-decision-batch-005-2026-07-23.json --decision docs/reports/blind-v2-source-classification-maintainer-decision-batch-006-2026-07-23.json --decision docs/reports/blind-v2-source-classification-maintainer-decision-batch-007-2026-07-23.json --decision docs/reports/blind-v2-source-classification-maintainer-decision-batch-008-2026-07-23.json --created-at 2026-07-23T00:00:00+08:00 --output $(BLIND_V2_POOL) --report docs/reports/blind-v2-candidate-promotion-batches-001-008-2026-07-23.md --check
