...
一行程式、一個 CLI、一個 Maven 座標 —— 三種語言都能把簡體轉成**真正的台灣繁體**。
...
<!-- zhtw:disable -->
**31,000+ 精選詞條 + 6,344 字元對映**，涵蓋 IT 科技、醫療、法律、金融、遊戲、電商、學術、日常、地理、港式用語 10+ 領域。轉換由雙層架構負責：**詞彙層**（Aho-Corasick 最長匹配）處理複合詞，**字元層**（`str.translate`）補齊剩餘簡體字。22 個一對多危險字（发/面/里/干 等）由詞彙層上下文判斷，不會錯轉。
<!-- zhtw:enable -->
