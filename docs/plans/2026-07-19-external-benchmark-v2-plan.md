...
- [x] 建立 permissioned-user-report 收集管線與第一批 100 筆空白模板：GitHub
  ...
  為 `collecting` 0/100，尚未加入目前 1,181 筆 candidate pool。
...
- [x] 建立 classification batch 015，完成 Codex first pass、Gemini via
  ...
  覆蓋、零工具呼叫、零 API 錯誤。
- [ ] Maintainer 確認 batch 015 synthesis 後，才建立 human decision artifact、
  執行 exact/reference 與 character 5-gram Jaccard 0.85 promotion gate；確認前
  pool 維持 1,181 筆。
