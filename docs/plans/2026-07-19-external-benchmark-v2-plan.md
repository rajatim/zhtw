...
- [x] 建立 permissioned-user-report 收集管線與第一批 100 筆空白模板：GitHub
  ...
  為 `collecting` 0/100，尚未加入目前 1,281 筆 candidate pool。
...
- [ ] Maintainer 確認 batch 016 synthesis 後，才建立 human decision artifact 並
  執行 promotion dedupe；確認前 pool 維持 1,281 筆。
