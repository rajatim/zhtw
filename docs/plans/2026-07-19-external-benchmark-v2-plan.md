...
- [ ] 2026-07-30 完成 batch 064 advisory：依前批比例風險暫停 AOSP，改由
  ...
  最終建議 88 筆納入、8 筆排除（94 agreement、2 codex_synthesis）。目前等待
  maintainer confirmation；尚未寫入 pool，pool 維持 5,518 筆。
