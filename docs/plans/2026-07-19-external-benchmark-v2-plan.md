...
- [x] 2026-07-30 完成正式 expected annotation batch 007：從 frozen inputs
  ...
  zhtw 或競品 converter。
- [ ] 2026-07-30 完成正式 expected annotation batch 008 advisory：從 frozen inputs
  ...
  缺漏或 Kubernetes lifecycle 語意交由 maintainer 確認。Private expected 尚未寫入，
  public annotation progress 維持 700/1,960；全程未執行 zhtw 或競品 converter。
