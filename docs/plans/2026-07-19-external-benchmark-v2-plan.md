...
- [ ] 2026-07-28 建立 batch 048 advisory：新增 checksum-pinned Ready.gov
  ...
  第三方資源文案而排除（35 agreement、40 Codex、21 hybrid）。等待 maintainer
  確認；尚未建立 human decision、尚未 promotion。
