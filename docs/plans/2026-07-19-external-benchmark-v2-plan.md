...
- [x] 2026-07-30 完成正式 expected annotation batch 003：從 frozen inputs
  ...
  zhtw 或競品 converter。
- [ ] 2026-07-30 完成正式 expected annotation batch 004 advisory：從 frozen inputs
  ...
  9 hybrid，其中 4 筆因來源語意或 Android 產品術語交由 maintainer 確認。Private
  expected 尚未寫入，public annotation progress 維持 300/1,960；全程未執行 zhtw
  或競品 converter。
